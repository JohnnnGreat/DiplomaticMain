...
const PagesHeader = ({ children }: { children: React.ReactNode }) => {
   return (
      <div className="w-full py-2 px-2">
         <div className="h-[150px] sm:h-[200px] bg-gradient rounded-lg shadow-md max-w-[1000px] flex items-center justify-center mx-auto px-4 sm:px-8 md:px-12 lg:px-16">
